  ...
  <>
   <div className='w-screen h-screen flex justify-end font-Archivo overflow-x-hidden relative'>
    	  ...
    	  Mint an NFT
    	   ...
    	   <div className='flex flex-row items-center justify-between w-[150px] px-2 mt-10'>
    ...
    <a target='_blank' rel="noreferrer" href='https://opensea.io/collection/masktalisman'>
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
className="w-8 h-8"
viewBox="0 0 50 50">
<path d="M25,2C12.317,2,2,12.317,2,25s10.317,23,23,23s23-10.317,23-23S37.683,2,25,2z M19,15c4,5,1,10,1,10h-7L19,15z M41,29	l-2.895,1.447c-0.708,0.354-1.246,0.974-1.496,1.725v0C35.648,35.055,32.95,38,29.911,38h-9.123c-4.551,0-8.491-4.161-9.478-8.603	L11,28h8c0,1.657,1.343,3,3,3h3v-4h-3c5-7-1-14-1-14s1.798,0.559,4,1.244V12c0-0.553,0.447-1,1-1s1,0.447,1,1v2.867	C38,21.4,30,27,30,27h-3v4h3.242c0.494,0,0.977-0.146,1.388-0.42L34,29l7-2V29z"></path>
</svg>
</a>
    </div>
</div>
    ...
    <div className='w-full md:w-[50%] h-screen md:px-5 pt-5 filter backdrop-blur-sm md:backdrop-blur-none'>
      ...
      <img src='/bg.jpeg' className='w-full h-auto object-cover rounded-md'/>
    	  ...
    	  <div className='flex flex-row items-center justify-between w-[150px] px-2 mt-10'>
    <a target='_blank' rel="noreferrer" href='https://twitter.com/MaskTalismanNFT'><svg xmlns="http://www.w3.org/2000/svg"  className="w-8 h-8 hover:scale-110" viewBox="0 0 24 24" ><path fill="#000" d="M19.633 7.997c.013.175.013.349.013.523 0 5.325-4.053 11.461-11.46 11.461-2.282 0-4.402-.661-6.186-1.809.324.037.636.05.973.05a8.07 8.07 0 0 0 5.001-1.721 4.036 4.036 0 0 1-3.767-2.793c.249.037.499.062.761.062.361 0 .724-.05 1.061-.137a4.027 4.027 0 0 1-3.23-3.953v-.05c.537.299 1.16.486 1.82.511a4.022 4.022 0 0 1-1.796-3.354c0-.748.199-1.434.548-2.032a11.457 11.457 0 0 0 8.306 4.215c-.062-.3-.1-.611-.1-.923a4.026 4.026 0 0 1 4.028-4.028c1.16 0 2.207.486 2.943 1.272a7.957 7.957 0 0 0 2.556-.973 4.02 4.02 0 0 1-1.771 2.22 8.073 8.073 0 0 0 2.319-.624 8.645 8.645 0 0 1-2.019 2.083z"></path></svg></a>
